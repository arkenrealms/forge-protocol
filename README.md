...
- Router guards missing/non-invokable `ctx.app.service.sync` and throws a clear error before dispatch, including constructor-aware received runtime type details (for example `undefined`, `null`, `object:Object`, `function:SyncHandler`) to speed misconfiguration triage.
